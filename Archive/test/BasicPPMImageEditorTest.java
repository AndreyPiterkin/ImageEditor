...
public class BasicPPMImageEditorTest {
  ...
  public void testConstructorInvalid() {
    assertThrows(NullPointerException.class, () -> new BasicPPMImageEditor(null));
  }
  ...
  public void testConstructorWithMapsHasProperInternalListOfNames() {
    ...
    editor = new BasicPPMImageEditor(images);
  ...
  public void testGetImage() {
    ...
    images.put("image1", image);
    images.put("image2", image2);
    ImageEditor editor = new BasicPPMImageEditor(images);
    assertEquals(image, editor.getImage("image1"));
