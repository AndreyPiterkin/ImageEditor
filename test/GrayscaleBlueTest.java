...
public class GrayscaleBlueTest {
  ...
  public void testApply() {
    ...
    assertEquals(new RGBAPixel(240), this.grayscaleBlue.apply(this.image, 0, 0));
    assertEquals(new RGBAPixel(241), this.grayscaleBlue.apply(this.image, 0, 1));
    assertEquals(new RGBAPixel(242), this.grayscaleBlue.apply(this.image, 1, 0));
    assertEquals(new RGBAPixel(243), this.grayscaleBlue.apply(this.image, 1, 1));
  }
}