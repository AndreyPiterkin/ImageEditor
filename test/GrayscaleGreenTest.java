...
public class GrayscaleGreenTest {
  ...
  public void testApply() {
    ...
    assertEquals(new RGBAPixel(128), this.grayscaleGreen.apply(this.image, 0, 0));
    assertEquals(new RGBAPixel(129), this.grayscaleGreen.apply(this.image, 0, 1));
    assertEquals(new RGBAPixel(130), this.grayscaleGreen.apply(this.image, 1, 0));
    assertEquals(new RGBAPixel(131), this.grayscaleGreen.apply(this.image, 1, 1));
  }
}