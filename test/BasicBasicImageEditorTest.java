...
//    pixels[0][0] = new RGBAPixel(1, 0, 0);
//    pixels[0][1] = new RGBAPixel(1, 0, 0);
//    pixels[0][2] = new RGBAPixel(1, 0, 0);
//    pixels[1][0] = new RGBAPixel(0, 1, 0);
//    pixels[1][1] = new RGBAPixel(0, 1, 0);
//    pixels[1][2] = new RGBAPixel(0, 1, 0);
//    pixels[2][0] = new RGBAPixel(0, 0, 1);
//    pixels[2][1] = new RGBAPixel(0, 0, 1);
//    pixels[2][2] = new RGBAPixel(0, 0, 1);
//    ImageState image = new ImagePPM(pixels);
//    editor.addImage(image, "image1");
...
//    for (int i = 0; i < 3; i++) {
//      for (int j = 0; j < 3; j++) {
//        assertEquals(new RGBAPixel(pixels[i][j].getRed() + 10, pixels[i][j].getGreen() + 10,
...
//    ImageEditor editor = new BasicImageEditor();
//    RGBAPixel[][] pixels = new RGBAPixel[3][3];
//    pixels[0][0] = new RGBAPixel(11, 10, 10);
//    pixels[0][1] = new RGBAPixel(11, 10, 10);
//    pixels[0][2] = new RGBAPixel(11, 10, 10);
//    pixels[1][0] = new RGBAPixel(10, 11, 10);
//    pixels[1][1] = new RGBAPixel(10, 11, 10);
//    pixels[1][2] = new RGBAPixel(10, 11, 10);
//    pixels[2][0] = new RGBAPixel(10, 10, 11);
//    pixels[2][1] = new RGBAPixel(10, 10, 11);
//    pixels[2][2] = new RGBAPixel(10, 10, 11);
//    ImageState image = new ImagePPM(pixels);
//    editor.addImage(image, "image1");
